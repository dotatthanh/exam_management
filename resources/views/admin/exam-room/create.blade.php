...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Thêm phòng thi</h4>

                    <form method="POST" action="{{ route('exam_rooms.store') }}" enctype="multipart/form-data">

                        @include('admin.exam-room._form', ['routeType' => 'create'])
